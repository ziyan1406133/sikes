                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="pull-right">
                            <a class="btn btn-md btn-secondary" href="/laporankeluar"><i class="fa fa-eye"></i></a>
                            <a class="btn btn-md btn-primary" data-toggle="modal" data-target="#filter" href="#"><i class="fa fa-filter"></i></a>
                            <a class="btn btn-md btn-primary" data-toggle="modal" data-target="#print" href="#"><i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
